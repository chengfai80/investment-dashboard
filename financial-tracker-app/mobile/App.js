...
import CustomBuilderScreen from './src/screens/CustomBuilderScreen';
...
function MoreHomeScreen({ navigation }) {
  const items = [
    ...
    { name: 'Custom Builder', icon: 'construct', screen: 'CustomBuilder' },
...
function MoreScreens() {
  return (
    <MoreStack.Navigator screenOptions={screenOptions}>
      ...
      <MoreStack.Screen name="CustomBuilder" component={CustomBuilderScreen} options={{ title: 'Custom Builder' }} />

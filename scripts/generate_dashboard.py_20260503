...
def generate_html(prices, gold_ohlcv, btc_ohlcv, news,
                  ...
                  ai_intl_stocks, ai_gold, ai_btc, ta_data=None):
...
def main():
    ...
    print("\n[1/7] Fetching live prices...")
    prices = fetch_prices()

    print("\n[2/7] Fetching Gold OHLCV (6 months)...")
    gold_ohlcv = fetch_ohlcv("GC=F", period="6mo")

    print("\n[3/7] Fetching Bitcoin OHLCV (6 months)...")
    btc_ohlcv = fetch_ohlcv("BTC-USD", period="6mo")

    print("\n[4/7] Fetching news headlines...")
    news = fetch_news()

    print("\n[5/7] Fetching AI-powered analysis via Gemini (grounded in live RSS)...")

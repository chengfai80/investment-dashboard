  ...
  return (
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={styles.wrap}>
      <View style={styles.card}>
        ...
        <Text style={styles.subtitle}>Sign in to manage leave and funnel records</Text>
        <Text style={styles.note}>Set EXPO_PUBLIC_API_BASE_URL to your API server.</Text>
...
const styles = StyleSheet.create({
  ...
  note: { color: '#38bdf8', marginBottom: 20, fontSize: 12 },
  input: { backgroundColor: '#111827', color: '#fff', borderRadius: 16, padding: 14, marginBottom: 12, borderWidth: 1, borderColor: '#1e293b' },
  button: { backgroundColor: '#38bdf8', borderRadius: 16, padding: 14, alignItems: 'center', marginTop: 8 },
